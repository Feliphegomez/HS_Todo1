...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Hulk Shop">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="images/logo_admin.png" alt="alternative"></a> 
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#features">DOCS</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle page-scroll" href="#details" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Mi Cuenta</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                
		                <% if(session!=null){ %>
			                <a class="dropdown-item" href="Profile"><span class="item-text">Mi Perfil</span></a>
	                        <a class="dropdown-items-divide-hr"></a>
	                        <a class="dropdown-item" href="Logout"><span class="item-text">Salir</span></a>
		                <% } else { %>
		               	<% } %>
		                	<a href="login.jsp" class="dropdown-item"><span class="item-text">Iniciar sesion</span></a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1>
                            	Ahora con <b>MÁS</b> !
                            	<br>
                            	<span id="js-rotating">Accesorios, Camisetas, Vasos, Comics, Juguetes, y mucho más</span>
                            </h1>
                            <p class="p-large">Descarga ya la App y Disfruta!</p>
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="images/demo-product-001.png" alt="alternative">
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Hulk Store | Todo1.com | Powered by <a href="https://github.com/Feliphegomez/">Feliphegomez</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
