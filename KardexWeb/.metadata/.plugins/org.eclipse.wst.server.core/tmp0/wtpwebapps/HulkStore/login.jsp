...
<html>
	<head>
		<title>Hulk Store | Login :: Todo1.com</title>
	...
	<body>
		...
		<div class="error_page">
			<!--/login-top-->
			<div class="error-top">
				<h2 class="inner-tittle page">HulkStore</h2>
				    <div class="login">
					<h3 class="inner-tittle t-inner">Ingresar</h3>
						<!-- // 
						...
						<form action="index.jsp" method="post">
							<input type="text" name="username" class="text" value="Usuario" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Usuario';}" >
