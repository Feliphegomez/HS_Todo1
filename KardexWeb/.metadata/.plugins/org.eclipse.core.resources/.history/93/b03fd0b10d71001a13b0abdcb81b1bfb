...
<body>
   <div class="page-container" id="vue_app">
   <!--/content-inner-->
	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			<div class="header-section">
					...
					<footer>
						<p>Create by <a href="https://github.com/Feliphegomez" target="_blank">FelipheGomez.</a></p>
					</footer>
					<!--footer section end-->
				</div>
			</div>
			...
			<div class="sidebar-menu">
				...
				<div style="border-top:1px solid rgba(69, 74, 84, 0.7)"></div>
					...
					<div class="down">	
					  	...
					  	<a href="index.jsp"><span class=" name-caret"><%= (String)session.getAttribute("firstname") %> <%= (String)session.getAttribute("lastname") %></span></a>
						 <p>
						...
						<ul>
							...
							<li><a class="tooltips" href="Logout"><span>Salir </span><i class="lnr lnr-power-switch"></i></a></li>
						</ul>
					</div>
				    <!--//down-->
                	<div class="menu">
